...
if ($psw == "password") {
	if ($_POST['test'] != "") {
		...
		echo 'You didn\'t even choose a quiz!</td><td></td></tr><tr><td><input type="reset" onclick="history.back(1);" value="< Back" /></td><td><input type=submit disabled value="Next >" /></td></tr></table>';
	}
} else {
